import 'package:ecommerce_app/controller/auth/verificationcodesignup_controller.dart';
...
class VerificationcodesignupScreen extends StatelessWidget {
  static const String routName = "/verificationcodesignup";
  const VerificationcodesignupScreen({super.key});

  @override
  Widget build(BuildContext context) {
    VerificationcodesignupControllerImplementation controller = Get.put(
      VerificationcodesignupControllerImplementation(),
    );
    return Scaffold(
      body: Container(
