...
class RegisterverificationemailScreen extends StatelessWidget {
  static const String routName = "/registerverificationemail";
  const RegisterverificationemailScreen({super.key});

  @override
  Widget build(BuildContext context) {
    RegistercheckemailControllerImplementation controller = Get.put(
      RegistercheckemailControllerImplementation(),
    );
    return Scaffold(
      body: Container(
